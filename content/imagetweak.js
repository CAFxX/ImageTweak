...
ImageTweak.prototype.ScreenCoordinates = function ScreenCoordinates() {
	...
	Coordinates.imgWidth    = ImageTweakHelper.clip( this.NaturalWidth() * Coordinates.CurZoom,  1, this.ImageMax );
	Coordinates.imgHeight   = ImageTweakHelper.clip( this.NaturalHeight() * Coordinates.CurZoom, 1, this.ImageMax );
...
ImageTweak.prototype.SetMouseMoveCursor = function SetMouseMoveCursor() {
	if ( ( this.Window.innerWidth < this.Image.width && this.Window.innerHeight < this.Image.height ) || this.GetPref("ClipMovement") == false ) {
	...
	} else if ( this.Window.innerHeight < this.Image.height ) {
...
ImageTweak.prototype.IsImageDocument = function IsImageDocument() {
...
ImageTweak.prototype.PluginContextMenu = function PluginContextMenu() {
	// TODO
};
